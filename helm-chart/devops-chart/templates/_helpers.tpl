...
helm.sh/chart: {{ include "devops-challenge.chart" . }}
{{ include "devops-challenge.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "devops-challenge.fullname" .) .Values.serviceAccount.name }}
{{- else }}
